...
from Services.departmentService import Departments
...
"background-image: url(:/newPrefix/649eb8ca76c20 (1).png);")
        ...
        self.label_3.setGeometry(QtCore.QRect(620, 10, 741, 111))
        font = QtGui.QFont()
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(1300, 400, 251, 51))
        ...
        self.comboBox_4.setGeometry(QtCore.QRect(1300, 330, 251, 51))
        self.comboBox_4.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.comboBox_4.setObjectName("comboBox_4")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(1300, 310, 61, 16))
        self.label.setObjectName("label")
        Management.setCentralWidget(self.centralwidget)

        self.connection = DatabaseConnection.get_connection()

        self.departments = Departments(self.connection)
        self.departments.load_data_to_tablewidget(self.tableWidget_2)
        ...
        self.departments.load_combobox_data(self.comboBox_4)
    ...
    def search(self):
        ...
        self.departments.search_data(keyword, self.tableWidget_2)

    def delete_record(self):
        self.departments.delete_selected_record(self.tableWidget_2)
    ...
    def save_data(self):
        ...
        faculty_id = self.comboBox_4.currentData()
