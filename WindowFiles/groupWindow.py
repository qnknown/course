...
# Form implementation generated from reading ui file 'groupWindow.ui'
#
...
"background-image: url(:/newPrefix/649eb8ca76c20 (1).png);")
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(1300, 440, 251, 51))
    ...
    def retranslateUi(self, Management):
        ...
        self.label_3.setText(_translate("Management", "Групи"))
        self.lineEdit_16.setPlaceholderText(_translate("Management", "Назва"))
        self.label_9.setText(_translate("Management", "Додати групу"))
        ...
        self.label.setText(_translate("Management", "Номер екзамену"))
