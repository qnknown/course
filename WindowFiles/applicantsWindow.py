...
from Services.applicantsService import Applicants


class Ui_Applicants(object):
...
"background-image: url(:/newPrefix/649eb8ca76c20 (1).png);")
        ...
        self.lineEdit_16.setGeometry(QtCore.QRect(1300, 250, 251, 51))
        self.lineEdit_16.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.lineEdit_16.setObjectName("lineEdit_16")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(1280, 150, 281, 111))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.comboBox_8.setGeometry(QtCore.QRect(1300, 330, 251, 51))
        self.comboBox_8.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.comboBox_8.setObjectName("comboBox_8")
        self.lineEdit_6 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_6.setGeometry(QtCore.QRect(100, 180, 271, 51))
        self.lineEdit_6.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.pushButton_16 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_16.setGeometry(QtCore.QRect(1300, 570, 251, 51))
        self.pushButton_16.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_16.setObjectName("pushButton_16")
        self.pushButton_18 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_18.setGeometry(QtCore.QRect(990, 180, 271, 51))
        ...
        self.comboBox_9.setGeometry(QtCore.QRect(1300, 490, 251, 51))
        self.comboBox_9.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.comboBox_9.setObjectName("comboBox_9")
        self.tableWidget_2 = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget_2.setGeometry(QtCore.QRect(100, 250, 1161, 691))
        ...
        self.pushButton_17.setGeometry(QtCore.QRect(1590, 250, 251, 51))
        self.pushButton_17.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_17.setObjectName("pushButton_17")
        self.comboBox_4 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_4.setGeometry(QtCore.QRect(1300, 410, 251, 51))
        ...
        self.applicants = Applicants(self.connection)

        self.applicants.load_data_to_tablewidget(self.tableWidget_2)
        ...
        self.applicants.load_combobox_data(self.comboBox_8, self.comboBox_4, self.comboBox_9)

    def delete_record(self):
        self.applicants.delete_selected_record(self.tableWidget_2)

    def search(self):
        keyword = self.lineEdit_6.text()
        self.applicants.search_data(keyword, self.tableWidget_2)
    ...
    def save_data(self):
        ...
        specialty_id = self.comboBox_8.currentData()
        is_privileged = self.comboBox_4.currentIndex()
    ...
    def update_data(self):
        self.applicants.update_data(self.tableWidget_2)


    def retranslateUi(self, Management):
        _translate = QtCore.QCoreApplication.translate
        Management.setWindowTitle(_translate("Management", "Керування БД"))
        self.label_3.setText(_translate("Management", "Заяви"))
        self.lineEdit_16.setPlaceholderText(_translate("Management", "ПІБ"))
        self.label_9.setText(_translate("Management", "Додати заяву"))
